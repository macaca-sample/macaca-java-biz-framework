...
public class BaseUtils {
    ...
    public static List<String> exec2(String cmd)  {
        ...
        if (cmd.startsWith("adb")) {
            ...
            String adbPath = androidHomePath + "/platform-tools/adb";
     ...
     * 启动app
     * Support: Android ios
     * 注：ios设备使用该方法时需提前在本机安装命令行工具libimobiledevice，
     * 安装方法：前往https://github.com/libimobiledevice/libimobiledevice
     * 将项目下载到本地，按照README进行配置、编译安装即可
     *
     * @param deviceType   设备类型 ios,android
     * @param deviceId     设备id,当存在多个设备时需指定设备id,如果只有一台设备，可以不必指定,ios:udid
     ...
     */
    public static void launchApp(String deviceType, String deviceId, String packageName, String activityName, String bundleId) throws Exception {
        if (deviceType == "android") {
